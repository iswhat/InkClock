# InkClock - 智能墨水屏时钟万年历系统

[English Version](README_EN.md)

## 项目简介

InkClock是一款基于多种开发板的智能墨水屏时钟万年历系统，支持ESP32、ESP8266、NRF52、STM32、RP2040等多种微控制器平台，具有低功耗、高清晰度、可远程配置等特点。系统集成了完整的万年历功能，支持显示公历、农历、节气、节日等信息，并具备人体感应、光照感应、低功耗优化等特性。同时，系统支持在线插件扩展，可通过配套的管理系统网站进行远程配置和管理。
