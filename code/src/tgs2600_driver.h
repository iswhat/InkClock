#ifndef TGS2600_DRIVER_H
#define TGS2600_DRIVER_H

#include "sensor_driver.h"

/**
 * @brief TGS2600气体传感器驱动类
 * 
 * 该类实现了TGS2600气体传感器的驱动，用于检测多种挥发性有机化合物。
 * TGS2600是一种模拟输出的气体传感器。
 */
class TGS2600Driver : public ISensorDriver {
private:
